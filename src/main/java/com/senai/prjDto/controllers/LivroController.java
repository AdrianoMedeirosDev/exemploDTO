package com.senai.prjDto.controllers;
...
import com.senai.prjDto.dto.LivroDTO;
import com.senai.prjDto.entities.Livro;
import com.senai.prjDto.service.LivroService;
...
public class LivroController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<LivroDTO> alteraLivroControl(@PathVariable Long id, @RequestBody @Valid Livro livro) {
